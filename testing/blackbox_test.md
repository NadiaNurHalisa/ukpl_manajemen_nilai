Blackbox Testing untuk sistem (Login/Register, Kelas, Siswa, Nilai) menggunakan teknik **Equivalence Partitioning**, **Boundary Value Analysis**, dan **Scenario-Based Testing**
